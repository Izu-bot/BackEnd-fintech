				...
				<tr>
					...
					<td>
						<c:url value="investimento" var="link">
							...
							<c:param name="codigo" value="${i.codigoInvestimento}" />
						</c:url>
						<a href="${link}" class="btn btn-primary btn-xs" >Editar</a>
						<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#excluirModal" onclick="codigoExcluir.value = ${i.codigoInvestimento}" >
  Excluir
</button>
					</td>
				</tr>
